            ...
            steps {
                script {
                    ...
                    withCredentials([string(credentialsId: 'SPLUNK_URL', variable: 'SPLUNK_URL'),
                        ...
                        dir("./nodejs/src/main/controller") {
                ...
                script {
                    ...
                    withCredentials([string(credentialsId: 'TWILIO_SID', variable: 'TWILIO_SID'),
                        ...
                        sh """
                            ...
                            curl -X DELETE -H 'Content-Type: application/json' https://${SWARM_MANAGER_IP_AND_DOCKER_PORT}/services/notifier  --cert ${LOCAL_DOCKER_CERT_PATH}/cert.pem --key ${LOCAL_DOCKER_CERT_PATH}/key.pem  --cacert ${LOCAL_DOCKER_CERT_PATH}/ca.pem
                            ...
                            curl -X POST -H 'Content-Type: application/json' --data-binary '@deploy-swarm.json' https://${SWARM_MANAGER_IP_AND_DOCKER_PORT}/services/create  --cert ${LOCAL_DOCKER_CERT_PATH}/cert.pem --key ${LOCAL_DOCKER_CERT_PATH}/key.pem  --cacert ${LOCAL_DOCKER_CERT_PATH}/ca.pem
                        """
                    }
                }
            }
